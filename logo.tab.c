...
{
      11,     0,    -1,    13,    -1,    11,    13,    -1,    13,    -1,
      12,    13,    -1,     3,     7,    -1,     4,     7,    -1,     5,
       7,    -1,     6,     7,     8,    12,     9,    -1
};
...
static const char *const yytname[] =
{
  ...
  "VALUE", "ENTREE", "FIN", "$accept", "BLOC", "BODY", "INSTRUCTION", YY_NULL
};
#endif
...
{
      12,    11,    13,     7,     1,     2,     3,     4,    15,    17,
       1,     2,     3,     4,     0,     8,    16,     1,     2,     3,
       4,     0,     9,    10
};
...
#line 50 "logo.y"
   ...
   (yyval.NODE_TYPE)=NewProg(); 
   (yyval.NODE_TYPE)=AddNode((yyval.NODE_TYPE), (yyvsp[(1) - (1)].NODE_TYPE)); 
   if(verification_branche==0)
   {
	tete=(yyval.NODE_TYPE);
...
#line 83 "logo.y"
   ...
   (yyval.NODE_TYPE)=NewNode(2, (yyvsp[(2) - (2)].VAL), NULL); 
}
    break;
...
#line 93 "logo.y"
   ...
   (yyval.NODE_TYPE)=NewNode(4, (yyvsp[(2) - (5)].VAL), (yyvsp[(4) - (5)].NODE_TYPE)); 
